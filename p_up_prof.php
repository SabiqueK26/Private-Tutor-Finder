...
<html>
	<head>
		<title>Parents - change profession</title>
	...
	<body>
		<div class="a_homepage">
			...
			<div class="cen-area">	
				...
				<p>
					Profession:
					<input class="textbox" placeholder="Enter New Profession" type="text" name="prof" required>
				</p>
				...
				<p>
					<input type="submit" name="up_prof" value="Update">
