...
<html>
	<head>
		<title>Tutors - change phone</title>
	...
	<body>
		<div class="a_homepage">
			...
			<div class="cen-area">	
				...
				<p>
					Phone:
					<input class="textbox" placeholder="Enter New Phone Number" type="text" name="tnum" required>
				</p>
				...
				<p>
					<input type="submit" name="up_tnum" value="Update">
